# Multilinear Regression on Capital Bikeshare Data

This repository contains R code and data for building a **multilinear regression** model to predict bike rental counts using the Capital Bikeshare dataset from Washington, D.C.

## Dataset

- **Source**: [UCI Machine Learning Repository – Bike Sharing Dataset](https://archive.ics.uci.edu/ml/datasets/Bike+Sharing+Dataset)
- **Files**: `data_bikeshare.csv` (hourly records; purposely cleaned dataset)
